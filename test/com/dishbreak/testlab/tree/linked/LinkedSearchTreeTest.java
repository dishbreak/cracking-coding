...
public class LinkedSearchTreeTest {
    ...
    public void testBuildFromArray() {
        ...
        assertEquals(
                "[( 2 => 35 ), ( 4 => 54 ), ( 5 => 34 ), ( 6 => 23 ), ( 7 => 67 ), ( 8 => 71 ), ( 9 => 24 ), ( 12 => 44 )]",
                tree.toString());
    }
    ...
    public void testSearchPositive() {
        LinkedTreeNode node = tree.search((LinkedTreeNode target) -> {
            return target.key().intValue() == 8;
        });
    ...
    public void testDeleteNonLeaf() {
        ...
        assertEquals("[( 2 => 35 ), ( 4 => 54 ), ( 5 => 34 ), ( 6 => 23 ), ( 8 => 71 ), ( 9 => 24 ), ( 12 => 44 )]",
                tree.toString());
    ...
    public void testDeleteLeaf() {
        ...
        assertEquals("[( 4 => 54 ), ( 5 => 34 ), ( 6 => 23 ), ( 7 => 67 ), ( 8 => 71 ), ( 9 => 24 ), ( 12 => 44 )]",
                tree.toString());
    ...
    public void testInsertNodesAtLevel() {
        ...
        assertEquals(
                "[[( 5 => 34 )], [( 4 => 54 ), ( 6 => 23 )], [( 2 => 35 ), ( 12 => 44 )], [( 7 => 67 )], [( 9 => 24 )], [( 8 => 71 )]]",
                nodes.toString());
    }
    ...
    public void testIsSubtreeMismatched() {
        int[] keys = { 50, 25, 75, 13, 40, 60, 100, 5, 6, 30, 45, 55, 70, 90, 120, 42, 48, 58, 47 };

        int[] subtreeKeys = { 40, 30, 45, 42, 60, 52 };
    ...
    public void testIsSubtreeMatched() {
        ...
        int[] subtreeKeys = { 40, 30, 45, 42, 48, 47 };
